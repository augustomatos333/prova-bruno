...
<nav class="navbar  navegacao">
  ...
  <div class=" btn-group col-lg-3 col-lg-offset-1  idioma" role: "group">
    <a href=" <?=$url?>/index.php?language=portugues"><button type="button" class="btn btn-default"><img src="img/br.png" alt="">&nbsp;PT-BR </button></a>
     <a href=" <?=$url?>/Index.php?language=ingles"><button type="button" class="btn btn-default"><img src="img/en.png" alt="">&nbsp;US-EN </button></a>
  </div>
</nav>
