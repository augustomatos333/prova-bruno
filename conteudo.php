...
require_once 'portugues.php';
  if ($_GET['cat'] == 'musica') {
    ...
    echo '<a href="#"><center><img src="'.$musica[$i].'" alt=""><center><h5><center>'.$titulos[$categoria][$i].'</center></h5></a>';
    echo '</div>';
      }
    ...
    echo '<a href="#"><center><img src="'.$esporte[$i].'" alt=""><center><h5><center>'.$titulos[$categoria][$i].'</center></h5></a>';
    echo '</div>';
      }
    ...
    for($i = 0; $i < 9; $i++){
    echo '<div class="video1 col-lg-4">';
    echo '<a href="#"><center><img src="'.$noticia[$i].'" alt=""><center><h5><center>Notícia</center></h5></a>';
    echo '</div>';
      }
  }
